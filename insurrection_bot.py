...
class Tiqqun:
    words = {
        ...
        "things_we_dont_like": [
            "activism", "representation", "humanism",
            "totality", "passivity", "banality",
            "fossilization of our desires",
            "mobilization", "impotentiality",
        ...
        "things_we_do": [
            "desire", "riot", "occupy everything"
        ],
        "our_things": [
            "communes", "multiplicities", "encounters",
            "becomings", "zones of offensive opacity", "desiring-bodies"
        ],
        "symbolic_things": [
            "burning dumpster", "smashed window",
            "moment of friendship", "car set aflame",
            "barricaded hallway"
        ],
        "things_we_do_to_things": [
            "destroy", "shatter", "negate", "reject"
        ],
        "things_we_dont_do": [
            "organize", "negotiate",
    ...
    def do_something(self):
        return """Our need to {} is less the {} of a {} than the {} of {}.""".format(*self.get_rand_words(
            "things_we_do",
            "making_things",
            "plans",
            "making_things",
    ...
    def break_things(self):
      return """We must {} all {} *{}*.
      """.format(*self.get_rand_words("things_we_do_to_things", "things_we_dont_like", "how_we_do_things"))
